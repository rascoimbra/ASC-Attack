...
public class TraducaoFase2 : MonoBehaviour
{
  ...
  //  public Text reward;
    ...
    void Start()
    {
        ...
        string url = "https://www.google-analytics.com/collect?v=1&tid=UA-17753792-10&cid=5555&t=pageview&dp=%2FASC-Attack-Fase2";
        WWW www = new WWW(url);
    }
    ...
    public void IdiomaIngles()
    {
     ...
     //   reward.text = "Earn 5 coins: ";
        mensagemMorreu.text = "You died... <br> :-( <br> Restarting in 5 seconds...";
